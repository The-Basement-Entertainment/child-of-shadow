...
namespace ViridaxGameStudios.AI
{
    ...
    public class AIController_Editor : Editor
    {
        ...
        void OnEnable()
        {
            ...
            aiTarget = soTarget.FindProperty("target");
        ...
        void DrawAISettingGUI()
        {
            ...
            label = new GUIContent("Target", "");
            EditorGUILayout.PropertyField(aiTarget, label);
        ...
        void DrawMovementGUI()
        {
            ...
            label = new GUIContent("A* Pathfinding:", "Allow the agent to pathfind.");
            character.enablePathfinding = EditorGUILayout.Toggle(label, character.enablePathfinding);
            label = new GUIContent("Obstacle Avoidance:", "Allow the agent to dynamically avoid immediate objects.");
            character.enableOA = EditorGUILayout.Toggle(label, character.enableOA);
        ...
        void DrawCombatGUI()
        {
            ...
            GUIContent label = new GUIContent("Attack Range", "The range that the AI will start attacking enemies.");
            ...
            EditorGUILayout.Space();
            EditorGUILayout.Space();
            label = new GUIContent("Enemy Tags", "All the Tags that the character will consider as an enemy. NOTE: The default reaction is to attack.");
            EditorGUILayout.LabelField(label, guiStyle);
